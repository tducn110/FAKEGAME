...
import svgPaths from "./svg-16qp268ado";
type WrapperProps = {
  ...
  return (
    <div className="relative size-full">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute contents left-[calc(50%-2px)] top-[calc(50%-2px)]">
          ...
          <div className="absolute inset-[-0.81%_-0.31%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 175.07 63.0019" xmlnsXlink="http://www.w3.org/1999/xlink">
              <g id="Union">
                ...
                <path d={svgPaths.p2ff8c00} fill="url(#pattern0_57_710)" fillOpacity="0.05" />
                <path d={svgPaths.p3fc62100} fill="var(--stroke-0, #9C466E)" />
              </g>
              <defs>
                <pattern height="1" id="pattern0_57_710" patternTransform="matrix(12.1264 0 0 12.1264 1.07006 1.02992)" patternUnits="userSpaceOnUse" preserveAspectRatio="none" viewBox="1.65705 1.65674 37.9118 37.9118" width="1">
                  <g id="pattern0_57_710_inner">
        ...
        <p className="-translate-x-1/2 absolute font-['Averia_Serif_Libre',serif] leading-[1.1] left-[calc(50%+1px)] not-italic text-[20px] text-center text-white top-[calc(50%-10px)] tracking-[-1.6px]">End Turn</p>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[35.411px] left-[calc(50%-62.75px)] top-[calc(50%-11.29px)] w-[60.494px]">
        <Frame427323160Helper>
          <g filter="url(#filter0_g_57_662)" id="Vector 1089">
            <path d={svgPaths.p3120fb00} fill="var(--fill-0, #EBDBC6)" />
            <path d={svgPaths.p33a8dc00} stroke="url(#paint0_linear_57_662)" strokeWidth="1.47546" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="40.8211" id="filter0_g_57_662" width="65.904" x="5.96046e-08" y="5.96046e-08">
              ...
              <feMerge result="effect1_texture_57_662">
                <feMergeNode in="displacedImage" />
              </feMerge>
            </filter>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_57_662" x1="65.5763" x2="6.8195" y1="-1.54943" y2="18.8469">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[35.411px] items-center justify-center left-[calc(50%+62.25px)] top-[calc(50%+15.71px)] w-[60.494px]">
        <div className="flex-none rotate-180">
          <div className="h-[35.411px] relative w-[60.494px]">
            <Frame427323160Helper>
              <g filter="url(#filter0_g_57_694)" id="Vector 1088">
                <path d={svgPaths.p3120fb00} fill="var(--fill-0, #EBDBC6)" />
                <path d={svgPaths.p33a8dc00} stroke="var(--stroke-0, #CBBBA5)" strokeWidth="1.47546" />
                <path d={svgPaths.p33a8dc00} stroke="url(#paint0_linear_57_694)" strokeWidth="1.47546" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="40.8211" id="filter0_g_57_694" width="65.904" x="5.96046e-08" y="5.96046e-08">
                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
                  <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                  <feTurbulence baseFrequency="0.021154331043362617 0.021154331043362617" numOctaves="3" seed="3148" type="fractalNoise" />
                  <feDisplacementMap height="100%" in="shape" result="displacedImage" scale="3.9345681667327881" width="100%" xChannelSelector="R" yChannelSelector="G" />
                  <feMerge result="effect1_texture_57_694">
                    <feMergeNode in="displacedImage" />
                  </feMerge>
                </filter>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_57_694" x1="32.7136" x2="32.7178" y1="3.97803" y2="38.1162">
                  <stop stopColor="#FFE8D7" />
                  <stop offset="0.278883" stopColor="#7E6C5F" />
                  <stop offset="0.754693" stopColor="#E4C3AC" />
                  <stop offset="1" stopColor="#8C7869" />
