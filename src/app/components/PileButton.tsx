...
import svgPaths from "../../imports/svg-bntdjjxan7";
...
export default function PileButton({ label, count }: PileButtonProps) {
  return (
    <div className="relative size-full" data-name="SECONDARY">
      ...
      <p className="-translate-x-1/2 absolute font-['Averia_Serif_Libre',serif] leading-[1.1] left-[81.8px] not-italic text-[#6d542f] text-[16.318px] text-center top-[calc(50%-8.9px)] tracking-[-1.3054px]">
        {label}: {count}
      </p>
